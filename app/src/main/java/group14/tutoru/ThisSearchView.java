 ...
 */
public interface ThisSearchView {

    String getSubject();
    Integer getPriceBand();
    Float getStarRating();

    void showSubjectError(int resId);

    void showStarRatingError(int starError);

    void showSpinnerError(int priceBandError);

    class search extends AppCompatActivity implements  AdapterView.OnItemSelectedListener, ThisSearchView {
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            Toast.makeText(search.this, "onCreate called", Toast.LENGTH_LONG).show();
             if (savedInstanceState != null)
             {
                //Toast.makeText(search.this, "if savedInstanceState != NULL", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(search.this, "if savedInstanceState = NULL", Toast.LENGTH_SHORT).show();
        ...
        public void onSaveInstanceState(Bundle savedInstanceState)
        {
            ...
            //Toast.makeText(search.this, "onSaveInstanceState", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(search.this, "onRestoreInstanceState", Toast.LENGTH_LONG).show();
